...
- **Multi-Backend Hardware Support**：FlagGems supports a wide range of hardware platforms and has been extensively tested across different hardware configurations. For more information, see [Supported hardware platforms](/getting_started/requirements.md#supported-hardware-platforms).
...
For more details, please refer to pointwise_dynamic(pointwise_dynamic.md). For more information, see [Dynamic generation of pointwise operators](/user_guide/pointwise-dynamic.md). 
