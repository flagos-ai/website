...
Based on this, the **Qwen3-Next-80B-A3B-Instruct-metax-FlagOS** model is adapted for the MetaX chip using the FlagOS software stack, enabling:
...
| Metrics           | Qwen3-Next-80B-A3B-Instruct-H100-CUDA | Qwen3-Next-80B-A3B-Instruct-FlagOS-metax |
|-------------------|--------------------------|-----------------------------|
| AIME_0fewshot_@avg1 | 0.800 | 0.867 |
| GPQA_0fewshot_@avg1 | 0.643 | 0.678 |
| LiveBench-0fewshot_@avg1 | 0.652 | 0.781 |
| MMLU_5fewshot_@avg1 | 0.715 | 0.814 |
| MUSR_0fewshot_@avg | 0.532 | 0.619 |
...
modelscope download --model FlagRelease/Qwen3-Next-80B-A3B-Instruct-metax-FlagOS --local_dir /nfs/Qwen3-Next-80B-A3B-Instruct
...
model = "Qwen3-Next-80B-A3B-Instruct-metax-flagos"
messages = [
