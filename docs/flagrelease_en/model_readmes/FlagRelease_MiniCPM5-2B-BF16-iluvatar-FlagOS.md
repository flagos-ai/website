...
# Evaluation Results
## Benchmark Result
| Metrics      | MiniCPM5-2B-Nvidia-Origin | MiniCPM5-2B-Iluvatar-FlagOS |
|--------------|--------------------------------|--------------------------------------|
| math_500           |           93.46                 |         93.00          |
| mmlu_pro_other |           51.52               |                52.60                 |
...
modelscope download --model FlagRelease/MiniCPM5-2B-BF16-iluvatar-FlagOS --local_dir /data/MiniCPM5-2B
```
...
docker run --shm-size="32g" -itd \
    ...
    --name flagos \
    harbor.baai.ac.cn/flagrelease-public/flagrelease-minicpm5-iluvatar-tree_none-gems_4.2.1rc0-vllm_0.13.0_cu102-plugin_0.0.0-cx_none-python_3.10.18-torch_2.7.1_corex.4.4.0-pcp_ixml4.4.0-gpu_iluvatar001-arc_amd64-driver_4.4.0:202605211637 \
    /bin/bash
