...
Based on this, the **Qwen3-8B-Nvidia-FlagOS** model is adapted for the Nvidia chip using the FlagOS software stack, enabling:
...
| Metrics   | Qwen3-8B-H100-CUDA | Qwen3-8B-FlagOS |
| --------- | ------------------ | ---------------------- |
| AIME_0fewshot_@avg1 | 0.700 | 0.700 |
| GPQA_0fewshot_@avg1 | 0.507 | 0.508 |
| LiveBench-0fewshot_@avg1 | 0.502 | 0.496 |
| MMLU_5fewshot_@avg1 | 0.699 | 0.702 |
| MUSR_0fewshot_@avg | 0.602 | 0.601 |
...
modelscope download --model Qwen/Qwen3-8B --local_dir /root/qwen3-8b
...
openai.base_url = "http://<server_ip>:8010/v1/"
