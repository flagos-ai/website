...
Based on this, the **RoboBrain2.0-7B-FlagOS-Nvidia** model is adapted for the Metax chip using the FlagOS software stack, enabling:
...
| --------------------- | ------------------------- | ----------------------------- |
| SAT                   | 75.330                    | 74.000                        |
| ALL_ANGLES_BENCH      | 47.700                    | 47.420                        |
| WHERE2PLACE           | 63.590                    | 63.350                        |
| BLINK_VAL_EV          | 56.360                    | 56.500                        |
| ROBO_SPATIAL_HOME_ALL | 54.227                    | 55.827                        |
| EGOPLAN_BENCH2        | 33.230                    | 33.540                        |
| ERQA                  | 38.750                    | 37.750                        |
| CV_BENCH_TEST         | 85.750                    | 85.860                        |
| EMBSPATIAL_BENCH      | 76.320                    | 76.180                        |
| VSI_BENCH_TINY        | 36.100                    | 35.460                        |
...
model = "RoboBrain2.0-7B-nv-flagos"
messages = [
