...
| Metrics   | phi-4-H100-CUDA | phi-4-Metax-FlagOS |
| --------- | ------------------ | ---------------------- |
| AIME_0fewshot_@avg1 | 0.200 | 0.167 |
| GPQA_0fewshot_@avg1 | 0.241 | 0.210 |
| MMLU_5fewshot_@avg1 | 0.713 | 0.714 |
| MUSR_0fewshot_@avg | 0.594 | 0.601 |
| LiveBench-0fewshot_@avg1 | 0.431 | 0.436 |
