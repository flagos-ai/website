...
# Evaluation Results
## Benchmark Result
| Metrics | Minicpm5-2B-Nvidia-Origin | Minicpm5-2B-Tsingmicro-FlagOS |
|--------------|--------------------------------|-------------------------------|
| math_500           |           93.46                  |         90.4       |
| mmlu_pro_other |            51.52               |                51.68         |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/minicpm-2b-tsingmicro001-gems4.2.1-treenone-cx0.1.0-plugin0.0.0-vllm0.20.2-sglangnone-sglangflnone-cp310-pt211-raisa1.4.0-x64-v0.28791.2:202609070855
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/Minicpm5-2B-BF16-tsingmicro-FlagOS --local_dir /data/Minicpm5-2B
```
...
docker run -d \
  ...
  -w /workspace \
  harbor.baai.ac.cn/flagrelease-public/minicpm-2b-tsingmicro001-gems4.2.1-treenone-cx0.1.0-plugin0.0.0-vllm0.20.2-sglangnone-sglangflnone-cp310-pt211-raisa1.4.0-x64-v0.28791.2:202609070855
...
### Start the Server
```bash
cd /home/secure/260629145101/vllm-mini 
source test_env.sh 
export TXDA_VISIBLE_DEVICES=0
bash server.sh
```
