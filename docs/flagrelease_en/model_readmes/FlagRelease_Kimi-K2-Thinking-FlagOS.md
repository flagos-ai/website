...
Based on this, the **Kimi-K2-Thinking-FlagOS** model is adapted for the Nvidia chip using the FlagOS software stack, enabling:
...
| Metrics           | Kimi-K2-Thinking-H100-CUDA | Kimi-K2-Thinking-FlagOS-nvidia |
|-------------------|--------------------------|-----------------------------|
| LiveBench-0fewshot_@avg1 | 75.190 | 74.580 |
| GPQA_0fewshot_@avg1 | 75.340 | 76.850 |
| MUSR_0fewshot_@avg | 68.390 | 68.650 |
| MMLU_5fewshot_@avg1 | 83.170 | 83.210 |
| AIME_0fewshot_@avg1 | 86.670 | 90.000 |
| math_500_0fewshot_@avg1 | 92.800 | 93.600 |
...
modelscope download --model FlagRelease/Kimi-K2-Thinking-FlagOS --local_dir /share/Kimi-K2-Thinking
...
model = "Kimi-K2-Thinking-nvidia-flagos"
messages = [
...
本模型的权重来源于moonshotai/Kimi-K2-Thinking，以apache2.0协议https://www.apache.org/licenses/LICENSE-2.0.txt开源。