...
# Evaluation Results
## Benchmark Result
| Metrics      | MiniCPM5-2B-Nvidia-Origin | MiniCPM5-2B-Metax-FlagOS |
|--------------|--------------------------------|--------------------------------------|
| math_500           |           93.46                  |         92.8          |
| mmlu_pro_other |            51.52               |               53.2                |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/minicpm5-metax001-gems5.0.2-tree0.5.1-cxnone-plugin0.2.0-vllm0.20.3-cp312-pt28-maca37-x64-3.8.1:202607151354
...
modelscope download --model FlagRelease/MiniCPM5-2B-BF16-metax-FlagOS --local_dir /data/MiniCPM5-2B
```
...
docker run -d \
    ...
    -v /data:/data \
    harbor.baai.ac.cn/flagrelease-public/minicpm5-metax001-gems5.0.2-tree0.5.1-cxnone-plugin0.2.0-vllm0.20.3-cp312-pt28-maca37-x64-3.8.1:202607151354 \
    sleep infinity
...
/opt/conda/bin/vllm serve /data/MiniCPM5-2B \
    --port 8000 \
    --served-model-name metaxcpm526 \
    --chat-template /data/MiniCPM5-2.6B/chat_template.jinja \
