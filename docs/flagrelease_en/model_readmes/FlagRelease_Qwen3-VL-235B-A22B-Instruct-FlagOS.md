...
Based on this, the **Qwen3-VL-235B-A22B-Instruct-FlagOS** model is adapted for the Nvidia chip using the FlagOS software stack, enabling:
...
| Metrics           | Qwen3-VL-235B-A22B-Instruct-H100-CUDA | Qwen3-VL-235B-A22B-Instruct-FlagOS |
|-------------------|--------------------------|-----------------------------|
| CMMMU | 59.440 | 58.330 |
| MMMU | 70.440 | 70.110 |
| MMMU_Pro_standard | 59.830 | 59.920 |
| MMMU_Pro_vision | 61.450 | 60.120 |
| MM-Vet v2 | 73.752 | 74.961 |
| OCRBench | 91.800 | 91.100 |
| MathVision | 68.420 | 68.620 |
| CII-Bench | 69.930 | 70.070 |
| Blink | 67.600 | 68.440 |
...
model = "Qwen3-VL-235B-A22B-Instruct-nvidia-flagos"
messages = [
...
本模型的权重来源于Qwen/Qwen3-VL-235B-A22B-Instruct，以apache2.0协议https://www.apache.org/licenses/LICENSE-2.0.txt开源。
