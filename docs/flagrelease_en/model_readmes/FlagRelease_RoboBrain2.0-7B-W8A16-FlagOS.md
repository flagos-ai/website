...
Based on this, the **RoboBrain2.0-7B-W8A16-FlagOS** model is adapted for the Nvidia chip using the FlagOS software stack, enabling:
...
| Metrics               | RoboBrain2.0-7B-H100-CUDA | RoboBrain2.0-7B-W8A16-FlagOS |
| --------------------- | ------------------------- | ---------------------------- |
| SAT                   | 75.330                    | 69.330                       |
| all_angles_bench      | 47.700                    | 46.860                       |
| Where2Place           | 63.590                    | 63.080                       |
| blink_val_ev          | 56.360                    | 56.360                       |
| robo_spatial_home_all | 54.227                    | 53.291                       |
| egoplan_bench2        | 33.230                    | 33.840                       |
| erqa                  | 38.750                    | 39.500                       |
| cv_bench_test         | 85.750                    | 85.730                       |
| embspatial_bench      | 76.320                    | 76.040                       |
| vsi_bench_tiny        | 36.100                    | 37.220                       |
...
modelscope download --model FlagRelease/RoboBrain2.0-7B-W8A16-FlagOS --local_dir /nfs/RoboBrain2.0-7B-W8A16
```
...
set the 【model path】 to /share/RoboBrain2.0-7B-W8A16
set the 【tensor_parallel_size】 to 4
set the 【served-model-name】 to RoboBrain2-7B-nvidia-flagos-W8A16
...
model = "RoboBrain2-7B-nvidia-flagos-W8A16"
messages = [
...
本模型以apache2.0协议https://www.apache.org/licenses/LICENSE-2.0.txt开源。