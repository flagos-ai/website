...
Qwen3-30B-A3B-FlagOS-nvidia  provides an all-in-one deployment solution, enabling execution of Qwen3-30B-A3B on nvidia GPUs. As the first-generation release for the nvidia-H100, this package delivers two key features:
...
We validate the execution of Qwen3-30B-A3B model with a Triton-based operator library as a PyTorch alternative.

We use a variety of Triton-implemented operation kernels  to run the Qwen3-30B-A3B model. These kernels come from two main sources:
