...
Based on this, the **Seed-OSS-36B-Instruct-FlagOS** model is adapted for the Nvidia chip using the FlagOS software stack, enabling:
...
| Metrics           | Seed-OSS-36B-Instruct-H100-CUDA | Seed-OSS-36B-Instruct-FlagOS |
|-------------------|--------------------------|-----------------------------|
| AIME_0fewshot_@avg1 | 0.900 | 0.833 |
| GPQA_0fewshot_@avg1 | 0.658 | 0.643 |
| LiveBench-0fewshot_@avg1 | 0.526 | 0.532 |
| MMLU_5fewshot_@avg1 | 0.801 | 0.802 |
| MUSR_0fewshot_@avg | 0.573 | 0.664 |
...
model = "Seed-OSS-36B-Instruct-nvidia-flagos"
messages = [
...
本模型的权重来源于ByteDance-Seed/Seed-OSS-36B-Instruct，以apache2.0协议https://www.apache.org/licenses/LICENSE-2.0.txt开源。
